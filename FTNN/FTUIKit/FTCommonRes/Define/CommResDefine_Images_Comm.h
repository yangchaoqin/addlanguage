...
#define IDIMG_COMMON_DATECTRL_DUARROW                       2402
...
static ImageListTable sg_imageListTable_Comm[] = 
{
    ...
    * @section 无
    * @response bobzhang\n
    * @description 分开定义了牛牛和moomoo的logo文件名\n
    * @location CommResDefine_Images_Comm.h
    */
#ifndef MOO_MOO
	...
	{ IDIMG_COMMON_DATECTRL_DUARROW, L"Btn_DateCtrl_DUArrow.png", 1, 8 },
};
